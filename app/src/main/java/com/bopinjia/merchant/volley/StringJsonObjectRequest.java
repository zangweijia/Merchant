package com.bopinjia.merchant.volley;
...
public class StringJsonObjectRequest<T> extends Request<String> {
	...
	public static interface Listener<T> {
		void onResponse(com.bopinjia.merchant.volley.ObjectResult<T> result);
	}
	...
	protected void deliverResponse(String arg0) {
		...
		com.bopinjia.merchant.volley.ObjectResult<T> result = new com.bopinjia.merchant.volley.ObjectResult<T>();
		try {
